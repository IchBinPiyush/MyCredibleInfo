        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(organisation.getText().toString().trim().length()>0&&designation.getText().toString().trim().length()>0)
                    ...
                    Toast.makeText(ProfessionalDetails.this,"Please enter valid data",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(ProfessionalDetails.this,"UID  : "+uid+" ID : "+id ,Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(ProfessionalDetails.this,Profile.class);
                    i.putExtra("id",uid);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ProfessionalDetails.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
