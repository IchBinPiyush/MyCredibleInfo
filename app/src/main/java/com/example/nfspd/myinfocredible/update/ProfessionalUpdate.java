        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(organisation.getText().toString().trim().length()>0&&designation.getText().toString().trim().length()>0)
                    ...
                    Toast.makeText(ProfessionalUpdate.this,"Please enter valid data",Toast.LENGTH_SHORT).show();
            }
        });
        ...
        JsonObjectRequest jsonObjectRequest  = new JsonObjectRequest(Request.Method.PUT, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Intent i= new Intent(ProfessionalUpdate.this, Profile.class);
                    Toast.makeText(ProfessionalUpdate.this,"Updated",Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ProfessionalUpdate.this,error.toString(),Toast.LENGTH_SHORT).show();
            }
        });
